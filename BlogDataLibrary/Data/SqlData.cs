...
namespace BlogDataLibrary.Data
{
    public class SqlData : ISqlData
    {
        ...
        //added
        //public UserModel Authenticate(int userId, string password)
        //{
        //    UserModel result = _db.LoadData<UserModel, dynamic>("dbo.spUsers_Authenticate",
        //                                                        new { userId, password },
        //                                                        connectionStringName, true).FirstOrDefault();
        ...
        {
            return _db.LoadData<ListPostModel, dynamic>("dbo.spPost_List", new { }, connectionStringName, true).ToList();
        }


        public ListPostModel ShowPostDetails(int id)
        {
            return _db.LoadData<ListPostModel, dynamic>("dbo.spPost_Detail", new { id }, connectionStringName, true).FirstOrDefault();
        }
